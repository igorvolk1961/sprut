...
Подробное описание см. в [README.md](AutoDMPas/README.md).
...
| **BattleModelLib** | Боевая модель — библиотека для моделирования боевых действий и анализа эффективности систем защиты. |
