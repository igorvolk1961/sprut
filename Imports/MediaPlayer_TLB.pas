...
// File generated on 02.03.05 13:15:10 from Type Library described below.
...
// *********************************************************************//
  IDirectContainer = interface(IUnknown)
    ...
    function CreateControl(const bszClsid: WideString; dwClsContext: LongWord; var ppunk: IUnknown; 
                           dwWindowStyle: LongWord): HResult; stdcall;
...
// *********************************************************************//
  IRadioPlayer = interface(IDispatch)
    ...
    function RegisterWindow(__MIDL_0012: Integer; dwMessage: LongWord; dwCodeSet: LongWord): Integer; safecall;
    ...
    procedure GetStatus(out plVolume: Integer; out pfMute: Integer; out pfPlay: Integer; 
                        out __MIDL_0013: WideString; out __MIDL_0014: WideString; 
                        out __MIDL_0015: WideString; out __MIDL_0016: WideString; 
                        out __MIDL_0017: WideString; out __MIDL_0018: WideString; 
                        out __MIDL_0019: WideString); safecall;
...
// *********************************************************************//
  IRadioPlayerDisp = dispinterface
    ...
    function RegisterWindow(__MIDL_0012: Integer; dwMessage: LongWord; dwCodeSet: LongWord): Integer; dispid 4;
    ...
    procedure GetStatus(out plVolume: Integer; out pfMute: Integer; out pfPlay: Integer; 
                        ...
                        out __MIDL_0015: WideString; out __MIDL_0016: WideString; 
                        out __MIDL_0017: WideString; out __MIDL_0018: WideString; 
                        out __MIDL_0019: WideString); dispid 11;
    procedure GetState(out plOpenState: Integer; out pfBuffering: Integer; 
...
// *********************************************************************//
  TMediaPlayerDVDNotify = procedure(Sender: TObject; EventCode: Integer; EventParam1: Integer; 
                                                     EventParam2: Integer) of object;
  TMediaPlayerEndOfStream = procedure(Sender: TObject; Result: Integer) of object;
  TMediaPlayerOpenStateChange = procedure(Sender: TObject; OldState: Integer; NewState: Integer) of object;
  TMediaPlayerPlayStateChange = procedure(Sender: TObject; OldState: Integer; NewState: Integer) of object;
  TMediaPlayerScriptCommand = procedure(Sender: TObject; const scType: WideString; 
                                                         const Param: WideString) of object;
  TMediaPlayerBuffering = procedure(Sender: TObject; Start: WordBool) of object;
  TMediaPlayerMarkerHit = procedure(Sender: TObject; MarkerNum: Integer) of object;
  TMediaPlayerWarning = procedure(Sender: TObject; WarningType: Integer; Param: Integer; 
                                                   const Description: WideString) of object;
  TMediaPlayerDisconnect = procedure(Sender: TObject; Result: Integer) of object;
  TMediaPlayerPositionChange = procedure(Sender: TObject; oldPosition: Double; newPosition: Double) of object;
  TMediaPlayerReadyStateChange = procedure(Sender: TObject; ReadyState: ReadyStateConstants) of object;

  TMediaPlayer = class(TOleControl)
  private
    FOnDVDNotify: TMediaPlayerDVDNotify;
    FOnEndOfStream: TMediaPlayerEndOfStream;
    FOnOpenStateChange: TMediaPlayerOpenStateChange;
    FOnPlayStateChange: TMediaPlayerPlayStateChange;
    FOnScriptCommand: TMediaPlayerScriptCommand;
    FOnBuffering: TMediaPlayerBuffering;
    FOnError: TNotifyEvent;
    FOnMarkerHit: TMediaPlayerMarkerHit;
    FOnWarning: TMediaPlayerWarning;
    FOnNewStream: TNotifyEvent;
    FOnDisconnect: TMediaPlayerDisconnect;
    FOnPositionChange: TMediaPlayerPositionChange;
    FOnDisplayModeChange: TNotifyEvent;
    FOnReadyStateChange: TMediaPlayerReadyStateChange;
    FIntf: IMediaPlayer;
    function  GetControlInterface: IMediaPlayer;
  protected
  ...
  public
    ...
    property  ControlInterface: IMediaPlayer read GetControlInterface;
    property  DefaultInterface: IMediaPlayer read GetControlInterface;
  ...
  published
    ...
    property OnDVDNotify: TMediaPlayerDVDNotify read FOnDVDNotify write FOnDVDNotify;
    property OnEndOfStream: TMediaPlayerEndOfStream read FOnEndOfStream write FOnEndOfStream;
    property OnOpenStateChange: TMediaPlayerOpenStateChange read FOnOpenStateChange write FOnOpenStateChange;
    property OnPlayStateChange: TMediaPlayerPlayStateChange read FOnPlayStateChange write FOnPlayStateChange;
    property OnScriptCommand: TMediaPlayerScriptCommand read FOnScriptCommand write FOnScriptCommand;
    property OnBuffering: TMediaPlayerBuffering read FOnBuffering write FOnBuffering;
    property OnError: TNotifyEvent read FOnError write FOnError;
    property OnMarkerHit: TMediaPlayerMarkerHit read FOnMarkerHit write FOnMarkerHit;
    property OnWarning: TMediaPlayerWarning read FOnWarning write FOnWarning;
    property OnNewStream: TNotifyEvent read FOnNewStream write FOnNewStream;
    property OnDisconnect: TMediaPlayerDisconnect read FOnDisconnect write FOnDisconnect;
    property OnPositionChange: TMediaPlayerPositionChange read FOnPositionChange write FOnPositionChange;
    property OnDisplayModeChange: TNotifyEvent read FOnDisplayModeChange write FOnDisplayModeChange;
    property OnReadyStateChange: TMediaPlayerReadyStateChange read FOnReadyStateChange write FOnReadyStateChange;
  end;
...
procedure TMediaPlayer.InitControlData;
const
...
procedure TMediaPlayer.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as IMediaPlayer;
  end;
...
function TMediaPlayer.GetControlInterface: IMediaPlayer;
begin
  CreateControl;
  Result := FIntf;
end;

function TMediaPlayer.Get_ActiveMovie: IDispatch;
begin
    Result := DefaultInterface.ActiveMovie;
end;

function TMediaPlayer.Get_NSPlay: IDispatch;
begin
    Result := DefaultInterface.NSPlay;
end;
...
function TMediaPlayer.GetMarkerTime(MarkerNum: Integer): Double;
begin
  Result := DefaultInterface.GetMarkerTime(MarkerNum);
end;

function TMediaPlayer.GetMarkerName(MarkerNum: Integer): WideString;
begin
  Result := DefaultInterface.GetMarkerName(MarkerNum);
end;

procedure TMediaPlayer.AboutBox;
begin
  DefaultInterface.AboutBox;
end;

function TMediaPlayer.GetCodecInstalled(CodecNum: Integer): WordBool;
begin
  Result := DefaultInterface.GetCodecInstalled(CodecNum);
end;

function TMediaPlayer.GetCodecDescription(CodecNum: Integer): WideString;
begin
  Result := DefaultInterface.GetCodecDescription(CodecNum);
end;

function TMediaPlayer.GetCodecURL(CodecNum: Integer): WideString;
begin
  Result := DefaultInterface.GetCodecURL(CodecNum);
end;

function TMediaPlayer.GetMoreInfoURL(MoreInfoType: MPMoreInfoType): WideString;
begin
  Result := DefaultInterface.GetMoreInfoURL(MoreInfoType);
end;

function TMediaPlayer.GetMediaInfoString(MediaInfoType: MPMediaInfoType): WideString;
begin
  Result := DefaultInterface.GetMediaInfoString(MediaInfoType);
end;

procedure TMediaPlayer.Cancel;
begin
  DefaultInterface.Cancel;
end;

procedure TMediaPlayer.Open(const bstrFileName: WideString);
begin
  DefaultInterface.Open(bstrFileName);
end;

function TMediaPlayer.IsSoundCardEnabled: WordBool;
begin
...
procedure TMediaPlayer.StreamSelect(StreamNum: Integer);
begin
  DefaultInterface.StreamSelect(StreamNum);
end;

procedure TMediaPlayer.FastForward;
begin
  DefaultInterface.FastForward;
end;

procedure TMediaPlayer.FastReverse;
begin
  DefaultInterface.FastReverse;
end;

function TMediaPlayer.GetStreamName(StreamNum: Integer): WideString;
begin
  Result := DefaultInterface.GetStreamName(StreamNum);
end;

function TMediaPlayer.GetStreamGroup(StreamNum: Integer): Integer;
begin
  Result := DefaultInterface.GetStreamGroup(StreamNum);
end;

function TMediaPlayer.GetStreamSelected(StreamNum: Integer): WordBool;
begin
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TMediaPlayer]);
end;
