...
// File generated on 04.05.04 20:10:37 from Type Library described below.
...
// Parent TypeLibrary:
//   (0) v8.1 Word, (C:\Program Files\Microsoft Office\Office\MSWORD9.OLB)
// Errors:
...
uses ActiveX, Classes, Graphics, Office_TLB, OleServer, StdVCL, Variants, 
Windows;
...
// *********************************************************************//
  VBE = interface(Application)
    ...
    property ActiveVBProject: VBProject read Get_ActiveVBProject;
    ...
    property ActiveCodePane: CodePane read Get_ActiveCodePane;
