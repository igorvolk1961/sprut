...
// File generated on 05.02.2007 13:39:31 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\Users\Volkov\Sprut3\bin\Sgdb.dll (1)
...
const
  ...
  LIBID_Sgdb: TGUID = '{24BBEAC0-5E99-11D5-845E-F63997C64D0C}';
...
// *********************************************************************//
  IOvercomeMethod = interface(IUnknown)
    ...
    function GetValueFromMatrix(const WarriorGroupU: IUnknown; const SafeguardElementU: IUnknown; 
                                ...
                                const Report: IDMText): Double; safecall;
    function Get_Preliminary: WordBool; safecall;
    function Get_Evidence: Integer; safecall;
    function Get_DependsOnGeometry: WordBool; safecall;
    ...
    property SkillTypes: IDMCollection read Get_SkillTypes;
    property Tactics: IDMCollection read Get_Tactics;
    property Preliminary: WordBool read Get_Preliminary;
    property Evidence: Integer read Get_Evidence;
    property DependsOnGeometry: WordBool read Get_DependsOnGeometry;
...
// *********************************************************************//
  IOvercomeMethodDisp = dispinterface
    ...
    property Preliminary: WordBool readonly dispid 4;
    property Evidence: Integer readonly dispid 7;
    property DependsOnGeometry: WordBool readonly dispid 14;
    function GetValueByCodeFromMatrix(const WarriorGroupU: IUnknown; 
                                      const SafeguardElementU: IUnknown; const LineU: IUnknown; 
...
{$ENDIF}
  ...
  protected
    ...
    function Get_SGDBParameters: IDMCollection;
    function Get_SGDBParameterValues: IDMCollection;
    function Get_DataClassModel: IDataModel;
    function Get_ZoneTypes: IDMCollection;
    function Get_ZoneKinds: IDMCollection;
    function Get_BoundaryTypes: IDMCollection;
    function Get_BoundaryKinds: IDMCollection;
    function Get_BoundaryLayerTypes: IDMCollection;
    function Get_CabelTypes: IDMCollection;
    function Get_WeaponKinds: IDMCollection;
    function Get_ToolKinds: IDMCollection;
    function Get_VehicleKinds: IDMCollection;
    function Get_SkillTypes: IDMCollection;
    function Get_AthorityTypes: IDMCollection;
    function Get_StartPointKinds: IDMCollection;
    function Get_Tactics: IDMCollection;
    function Get_MethodArrayValues: IDMCollection;
    function Get_SphearSectorImage: IDMElement;
    function Get_CommunicationDeviceTypes: IDMCollection;
    function Get_BattleSkills: IDMCollection;
    function Get_JumpKinds: IDMCollection;
    function Get_Updating: IDMCollection;
    function Get_UserDefinedValueMethod: IDMElement;
  public
...
function TSafeguardDatabaseProperties.Get_SGDBParameters: IDMCollection;
begin
    Result := DefaultInterface.SGDBParameters;
end;

function TSafeguardDatabaseProperties.Get_SGDBParameterValues: IDMCollection;
begin
    Result := DefaultInterface.SGDBParameterValues;
end;

function TSafeguardDatabaseProperties.Get_DataClassModel: IDataModel;
begin
    Result := DefaultInterface.DataClassModel;
end;

function TSafeguardDatabaseProperties.Get_ZoneTypes: IDMCollection;
begin
    Result := DefaultInterface.ZoneTypes;
end;

function TSafeguardDatabaseProperties.Get_ZoneKinds: IDMCollection;
begin
    Result := DefaultInterface.ZoneKinds;
end;

function TSafeguardDatabaseProperties.Get_BoundaryTypes: IDMCollection;
begin
    Result := DefaultInterface.BoundaryTypes;
end;

function TSafeguardDatabaseProperties.Get_BoundaryKinds: IDMCollection;
begin
    Result := DefaultInterface.BoundaryKinds;
end;

function TSafeguardDatabaseProperties.Get_BoundaryLayerTypes: IDMCollection;
begin
    Result := DefaultInterface.BoundaryLayerTypes;
end;

function TSafeguardDatabaseProperties.Get_CabelTypes: IDMCollection;
begin
    Result := DefaultInterface.CabelTypes;
end;

function TSafeguardDatabaseProperties.Get_WeaponKinds: IDMCollection;
begin
    Result := DefaultInterface.WeaponKinds;
end;

function TSafeguardDatabaseProperties.Get_ToolKinds: IDMCollection;
begin
    Result := DefaultInterface.ToolKinds;
end;

function TSafeguardDatabaseProperties.Get_VehicleKinds: IDMCollection;
begin
    Result := DefaultInterface.VehicleKinds;
end;

function TSafeguardDatabaseProperties.Get_SkillTypes: IDMCollection;
begin
    Result := DefaultInterface.SkillTypes;
end;

function TSafeguardDatabaseProperties.Get_AthorityTypes: IDMCollection;
begin
    Result := DefaultInterface.AthorityTypes;
end;

function TSafeguardDatabaseProperties.Get_StartPointKinds: IDMCollection;
begin
    Result := DefaultInterface.StartPointKinds;
end;

function TSafeguardDatabaseProperties.Get_Tactics: IDMCollection;
begin
    Result := DefaultInterface.Tactics;
end;

function TSafeguardDatabaseProperties.Get_MethodArrayValues: IDMCollection;
begin
    Result := DefaultInterface.MethodArrayValues;
end;

function TSafeguardDatabaseProperties.Get_SphearSectorImage: IDMElement;
begin
    Result := DefaultInterface.SphearSectorImage;
end;

function TSafeguardDatabaseProperties.Get_CommunicationDeviceTypes: IDMCollection;
begin
    Result := DefaultInterface.CommunicationDeviceTypes;
end;

function TSafeguardDatabaseProperties.Get_BattleSkills: IDMCollection;
begin
    Result := DefaultInterface.BattleSkills;
end;

function TSafeguardDatabaseProperties.Get_JumpKinds: IDMCollection;
begin
    Result := DefaultInterface.JumpKinds;
end;

function TSafeguardDatabaseProperties.Get_Updating: IDMCollection;
begin
    Result := DefaultInterface.Updating;
end;

function TSafeguardDatabaseProperties.Get_UserDefinedValueMethod: IDMElement;
begin
    Result := DefaultInterface.UserDefinedValueMethod;
end;
