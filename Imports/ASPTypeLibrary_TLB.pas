...
// PASTLWTR : 1.2
// File generated on 04.06.2005 22:42:05 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\WINDOWS\system32\inetsrv\asp.dll (1)
// LIBID: {D97A6DA0-A85C-11CF-83AE-00A0C90C2BD8}
// LCID: 0
// Helpfile: 
...
// Parent TypeLibrary:
//   (0) v1.0 PayDox, (c:\paydox\core\PayDox.dll)
// Errors:
...
// *********************************************************************//
  IResponseDisp = dispinterface
    ['{D97A6DA0-A864-11CF-83BE-00A0C90C2BD8}']
    property Buffer: WordBool dispid 1610743808;
    property ContentType: WideString dispid 1610743810;
    function Expires: OleVariant; dispid 1610743812;
    function ExpiresAbsolute: OleVariant; dispid 1610743814;
    property Cookies: IRequestDictionary readonly dispid 1610743816;
    property Status: WideString dispid 1610743817;
    ...
    property CharSet: WideString dispid 1610743830;
    procedure Pics(const bstrHeaderValue: WideString); dispid 1610743832;
    property CacheControl: WideString dispid 1610743833;
    property CodePage: Integer dispid 1610743835;
    property LCID: Integer dispid 1610743837;
  end;
...
// *********************************************************************//
  ISessionObjectDisp = dispinterface
    ...
    property Timeout: Integer dispid 1610743812;
    procedure Abandon; dispid 1610743814;
    property CodePage: Integer dispid 1610743815;
    property LCID: Integer dispid 1610743817;
...
// *********************************************************************//
  IServerDisp = dispinterface
    ['{D97A6DA0-A867-11CF-83AE-01A0C90C2BD8}']
    property ScriptTimeout: Integer dispid 1610743808;
