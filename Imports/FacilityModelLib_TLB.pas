...
// File generated on 13.06.2007 16:51:08 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\Users\Volkov\Sprut3\bin\FacilityModelLib.dll (1)
...
const
  ...
  gtInterruptOnFirstDetectionPoint = $00000001;
  gtInterruptOnPath = $00000002;
  gtStayOnPost = $00000003;
  gtInterruptOnTarget = $00000004;
  gtInterruptOnExit = $00000005;
  gtInterruptOnNextDetectionPoint = $00000006;
  gtInterruptOnTargetExit = $00000007;
...
// *********************************************************************//
  IZone = interface(IUnknown)
    ...
    function Get_LightDevices: IDMCollection; safecall;
    procedure AddDistantDetection(const aElement: IDMElement); safecall;
    procedure RemoveDistantDetection(const aElement: IDMElement); safecall;
    function Get_SurfaceSensors: IDMCollection; safecall;
...
// *********************************************************************//
  IZoneDisp = dispinterface
    ...
    property GuardPosts: IDMCollection readonly dispid 15;
    property TVCameras: IDMCollection readonly dispid 16;
    property VolumeSensors: IDMCollection readonly dispid 17;
    property VehicleVelocity: Double readonly dispid 18;
    property PedestrialVelocity: Double readonly dispid 19;
    property LightDevices: IDMCollection readonly dispid 11;
    procedure AddDistantDetection(const aElement: IDMElement); dispid 20;
    procedure RemoveDistantDetection(const aElement: IDMElement); dispid 21;
    property SurfaceSensors: IDMCollection readonly dispid 22;
    procedure MakeHVAreas(const theHAreas: IDMCollection; const theVAreas: IDMCollection; 
    ...
    property PerimeterSensors: IDMCollection readonly dispid 27;
...
// *********************************************************************//
  IBoundary = interface(IUnknown)
    ...
    function Get_GuardPosts0: IDMCollection; safecall;
    function Get_GuardPosts1: IDMCollection; safecall;
    function Get_TVCameras0: IDMCollection; safecall;
    function Get_TVCameras1: IDMCollection; safecall;
    function Get_BackRefs: IDMCollection; safecall;
    function MakeTemporyPath: IDMElement; safecall;
    procedure RemoveDistantDetection(const aElement: IDMElement); safecall;
    function Get_LightDevices0: IDMCollection; safecall;
    function Get_LightDevices1: IDMCollection; safecall;
    procedure AddDistantDetection(const aElement: IDMElement; const PrevAreaE: IDMElement; 
                                  Side: Integer; Distance: Double); safecall;
    ...
    function CalcNoDistantDetectionProbability(Side: Integer; const Zone0E: IDMElement; 
                                               const Zone1E: IDMElement; out BestPS: Double; 
                                               out BestNoPrelDetP: Double; 
                                               out BestNoEvidDetP: Double; 
                                               out BestTacticE: IDMElement): Double; safecall;
    procedure CalcExternalDelayTime(NodeDirection: Integer; out dT: Double; out dTDisp: Double; 
                                    out BestTacticE: IDMElement); safecall;
    function Get_NeighbourDist0: Double; safecall;
    function Get_NeighbourDist1: Double; safecall;
    procedure Reset(const BaseStateE: IDMElement); safecall;
    function Get_WarriorPaths: IDMCollection; safecall;
    function Get_GuardDelays0: IDMCollection; safecall;
    function Get_GuardDelays1: IDMCollection; safecall;
    ...
    function Get_VerificationGroup: IDMElement; safecall;
    ...
    property GuardPosts0: IDMCollection read Get_GuardPosts0;
    property GuardPosts1: IDMCollection read Get_GuardPosts1;
    property TVCameras0: IDMCollection read Get_TVCameras0;
    property TVCameras1: IDMCollection read Get_TVCameras1;
    property BackRefs: IDMCollection read Get_BackRefs;
    property LightDevices0: IDMCollection read Get_LightDevices0;
    property LightDevices1: IDMCollection read Get_LightDevices1;
    ...
    property WarriorPaths: IDMCollection read Get_WarriorPaths;
    property GuardDelays0: IDMCollection read Get_GuardDelays0;
    property GuardDelays1: IDMCollection read Get_GuardDelays1;
    ...
    property VerificationGroup: IDMElement read Get_VerificationGroup;
...
// *********************************************************************//
  IBoundaryDisp = dispinterface
    ...
    property GuardPosts0: IDMCollection readonly dispid 13;
    property GuardPosts1: IDMCollection readonly dispid 14;
    property TVCameras0: IDMCollection readonly dispid 15;
    property TVCameras1: IDMCollection readonly dispid 16;
    property BackRefs: IDMCollection readonly dispid 17;
    function MakeTemporyPath: IDMElement; dispid 18;
    procedure RemoveDistantDetection(const aElement: IDMElement); dispid 19;
    property LightDevices0: IDMCollection readonly dispid 20;
    property LightDevices1: IDMCollection readonly dispid 21;
    procedure AddDistantDetection(const aElement: IDMElement; const PrevAreaE: IDMElement; 
                                  Side: Integer; Distance: Double); dispid 22;
    ...
    function CalcNoDistantDetectionProbability(Side: Integer; const Zone0E: IDMElement; 
                                               ...
                                               out BestNoPrelDetP: Double; 
                                               out BestNoEvidDetP: Double; 
                                               out BestTacticE: IDMElement): Double; dispid 1;
    procedure CalcExternalDelayTime(NodeDirection: Integer; out dT: Double; out dTDisp: Double; 
                                    out BestTacticE: IDMElement); dispid 4;
    ...
    property GuardDelays0: IDMCollection readonly dispid 26;
    property GuardDelays1: IDMCollection readonly dispid 27;
    ...
    property VerificationGroup: IDMElement readonly dispid 31;
...
// *********************************************************************//
  IBoundaryLayer = interface(IUnknown)
    ...
    procedure Reset(const BaseStateE: IDMElement); safecall;
    function AcceptableTactic(const TacticU: IUnknown; ForceAndNotForce: WordBool): WordBool; safecall;
...
// *********************************************************************//
  IBoundaryLayerDisp = dispinterface
    ...
    function AcceptableTactic(const TacticU: IUnknown; ForceAndNotForce: WordBool): WordBool; dispid 13;
    property SubBoundaries: IDMCollection readonly dispid 2;
    procedure ClearCash; dispid 15;
...
// *********************************************************************//
  IFacilityElement = interface(IUnknown)
    ...
    function Get_ReactionProbability: Double; safecall;
    ...
    property PatrolPeriod: Double read Get_PatrolPeriod;
    property ReactionProbability: Double read Get_ReactionProbability;
...
// *********************************************************************//
  IFacilityElementDisp = dispinterface
    ...
    property ReactionProbability: Double readonly dispid 1;
...
// *********************************************************************//
  IPathElement = interface(IUnknown)
    ...
    procedure CalcDelayTime(out DelayTime: Double; out DelayTimeDispersion: Double; 
                            out BestTacticE: IDMElement; UseOldValue: WordBool); safecall;
    procedure CalcPathNoDetectionProbability(var PathNoDetectionProbability: Double; 
                                             var PathNoDetectionProbability0: Double; 
                                             out NoDetPOuter: Double; out NoDetPCent: Double; 
                                             out NoDetPInner: Double; out RejDetP: Double; 
                                             out NoPrelDetP: Double; out NoEvidDetP: Double); safecall;
    procedure CalcPathSuccessProbability(var SuccessProbability: Double; 
                                         var SuccessProbability0: Double; 
                                         var SuccessProbability1: Double; 
                                         out OutstripProbability: Double; var DelayTimeSum: Double; 
                                         var DelayTimeDispersionSum: Double; UseOldValue: WordBool; 
                                         const WarriorPathE: IDMElement; 
                                         StartPAthElementJ: Integer; 
                                         const NextBoundaryE: IDMElement; GuardTacticFlag: WordBool); safecall;
    procedure CalcPathSoundResistance(var PathSoundResistance: Double; var PathDistance: Double); safecall;
    procedure CalcNoDetectionProbability(out NoDetPOuter: Double; out NoDetPCent: Double; 
                                         out NoDetPInner: Double; out RejDetPOuter: Double; 
                                         out RejDetPCent: Double; out RejDetPInner: Double; 
                                         out NoPrelDetPOuter: Double; out NoPrelDetPCent: Double; 
                                         out NoPrelDetPInner: Double; out NoEvidDetPOuter: Double; 
                                         out NoEvidDetPCent: Double; out NoEvidDetPInnert: Double; 
                                         out BestTacticE: IDMElement); safecall;
    procedure DoCalcDelayTime(const TacticU: IUnknown; out DelayTime: Double; 
                              out DelayTimeDispersion: Double); safecall;
    procedure DoCalcNoDetectionProbability(const TacticU: IUnknown; out NoDetPOuter: Double; 
                                           out NoDetPCent: Double; out NoDetPInner: Double; 
                                           out RejDetPOuter: Double; out RejDetPCent: Double; 
                                           out RejDetPInner: Double; out NoPrelDetPOuter: Double; 
                                           out NoPrelDetPCent: Double; out NoPrelDetPInner: Double; 
                                           out NoEvidDetPOuter: Double; out NoEvidDetPCent: Double; 
                                           out NoEvidDetPInner: Double; out BestTimeSum: Double; 
                                           out BestTimeDispSum: Double); safecall;
    procedure DoCalcPathSuccessProbability(const TacticU: IUnknown; var SuccessProbability: Double; 
                                           var SuccessProbability0: Double; 
                                           var SuccessProbability1: Double; 
                                           ...
                                           GuardTacticFlag: WordBool); safecall;
    procedure CalcPathNoDetectionProbability0(var PathNoDetectionProbability: Double; 
                                              var PathNoDetectionProbability0: Double); safecall;
    procedure CalcNoDetectionProbability0(out NoDetP: Double; out RejDetP: Double; 
                                          UseOldValue: WordBool); safecall;
    function Get_Disabled: WordBool; safecall;
    procedure CalcDirectPathSuccessProbability(var SuccessProbability: Double; 
                                               var SuccessProbability0: Double; 
                                               var SuccessProbability1: Double; 
                                               DelayTimeOuter: Double; 
                                               DelayTimeDispersionSumOuter: Double; 
                                               DelayTimeSumInner: Double; 
                                               DelayTimeDispersionSumInner: Double; 
                                               const WarriorPathE: IDMElement; 
                                               StaertPathElementJ: Integer); safecall;
...
// *********************************************************************//
  IPathElementDisp = dispinterface
    ['{9DCB5BA7-14B5-11D6-932D-0050BA51A6D3}']
    procedure CalcDelayTime(out DelayTime: Double; out DelayTimeDispersion: Double; 
                            out BestTacticE: IDMElement; UseOldValue: WordBool); dispid 1;
    procedure CalcPathNoDetectionProbability(var PathNoDetectionProbability: Double; 
                                             var PathNoDetectionProbability0: Double; 
                                             out NoDetPOuter: Double; out NoDetPCent: Double; 
                                             out NoDetPInner: Double; out RejDetP: Double; 
                                             out NoPrelDetP: Double; out NoEvidDetP: Double); dispid 2;
    procedure CalcPathSuccessProbability(var SuccessProbability: Double; 
                                         var SuccessProbability0: Double; 
                                         var SuccessProbability1: Double; 
                                         out OutstripProbability: Double; var DelayTimeSum: Double; 
                                         ...
                                         const WarriorPathE: IDMElement; 
                                         StartPAthElementJ: Integer; 
                                         const NextBoundaryE: IDMElement; GuardTacticFlag: WordBool); dispid 3;
    ...
    procedure CalcNoDetectionProbability(out NoDetPOuter: Double; out NoDetPCent: Double; 
                                         ...
                                         out NoPrelDetPInner: Double; out NoEvidDetPOuter: Double; 
                                         out NoEvidDetPCent: Double; out NoEvidDetPInnert: Double; 
                                         out BestTacticE: IDMElement); dispid 6;
    procedure DoCalcDelayTime(const TacticU: IUnknown; out DelayTime: Double; 
                              out DelayTimeDispersion: Double); dispid 8;
    procedure DoCalcNoDetectionProbability(const TacticU: IUnknown; out NoDetPOuter: Double; 
                                           out NoDetPCent: Double; out NoDetPInner: Double; 
                                           out RejDetPOuter: Double; out RejDetPCent: Double; 
                                           out RejDetPInner: Double; out NoPrelDetPOuter: Double; 
                                           ...
                                           out NoEvidDetPOuter: Double; out NoEvidDetPCent: Double; 
                                           out NoEvidDetPInner: Double; out BestTimeSum: Double; 
                                           out BestTimeDispSum: Double); dispid 9;
    procedure DoCalcPathSuccessProbability(const TacticU: IUnknown; var SuccessProbability: Double; 
                                           var SuccessProbability0: Double; 
                                           var SuccessProbability1: Double; 
                                           out OutstripProbability: Double; out StealthT: Double; 
                                           ...
                                           StartPAthElementJ: Integer; 
                                           const NextBoundaryE: IDMElement; 
                                           GuardTacticFlag: WordBool); dispid 10;
    procedure CalcPathNoDetectionProbability0(var PathNoDetectionProbability: Double; 
                                              var PathNoDetectionProbability0: Double); dispid 5;
    procedure CalcNoDetectionProbability0(out NoDetP: Double; out RejDetP: Double; 
                                          UseOldValue: WordBool); dispid 7;
    ...
    procedure CalcDirectPathSuccessProbability(var SuccessProbability: Double; 
                                               ...
                                               DelayTimeDispersionSumInner: Double; 
                                               const WarriorPathE: IDMElement; 
                                               StaertPathElementJ: Integer); dispid 12;
  end;
...
// *********************************************************************//
  ISafeguardElement = interface(IUnknown)
    ...
    procedure CalcDetectionProbability(const TacticU: IUnknown; DelayTime: Double; 
                                       out DetP: Double; out BestTime: Double); safecall;
    ...
    function DoCalcDetectionProbability(const TacticU: IUnknown; const OvercomeMethodE: IDMElement; 
                                        ...
                                        var DetPg: Double; var DetPtv: Double; var DetPptr: Double; 
...
// *********************************************************************//
  ISafeguardElementDisp = dispinterface
    ...
    procedure CalcDetectionProbability(const TacticU: IUnknown; DelayTime: Double; 
                                       out DetP: Double; out BestTime: Double); dispid 5;
    procedure CalcDelayTime(const TacticU: IUnknown; out DelayTime: Double; 
...
// *********************************************************************//
  IDistantDetectionElementDisp = dispinterface
    ...
    property BackRefs: IDMCollection readonly dispid 3;
  end;
...
// *********************************************************************//
  IWarriorPathElement = interface(IUnknown)
    ...
    function Get_NoPrelDetP: Double; safecall;
    procedure Set_NoPrelDetP(Value: Double); safecall;
    function Get_NoEvidDetP: Double; safecall;
    procedure Set_NoEvidDetP(Value: Double); safecall;
    ...
    property NoPrelDetP: Double read Get_NoPrelDetP write Set_NoPrelDetP;
    property NoEvidDetP: Double read Get_NoEvidDetP write Set_NoEvidDetP;
...
// *********************************************************************//
  IWarriorPathElementDisp = dispinterface
    ...
    property NoPrelDetP: Double dispid 14;
    property NoEvidDetP: Double dispid 15;
...
// *********************************************************************//
  IGuardModel = interface(IDispatch)
    ...
    function Get_VerificationGroups: IDMCollection; safecall;
    ...
    property VerificationGroups: IDMCollection read Get_VerificationGroups;
...
// *********************************************************************//
  IGuardModelDisp = dispinterface
    ...
    property VerificationGroups: IDMCollection readonly dispid 2;
...
// Server Object    : TFacilityModel
// Help String      : FacilityModel
// Default Interface: IFacilityModel
// Def. Intf. DISP? : No
// Event   Interface: 
// TypeFlags        : (2) CanCreate
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TFacilityModelProperties= class;
{$ENDIF}
  TFacilityModel = class(TOleServer)
  private
    FIntf:        IFacilityModel;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TFacilityModelProperties;
    function      GetServerProperties: TFacilityModelProperties;
{$ENDIF}
    function      GetDefaultInterface: IFacilityModel;
  protected
    procedure InitServerData; override;
    function Get_Zones: IDMCollection;
    function Get_Boundaries: IDMCollection;
    function Get_BoundaryLayers: IDMCollection;
    function Get_FacilityStates: IDMCollection;
    function Get_FacilitySubStates: IDMCollection;
    function Get_ZoneStates: IDMCollection;
    function Get_BoundaryLayerStates: IDMCollection;
    function Get_SafeguardElementStates: IDMCollection;
    function Get_WarriorPaths: IDMCollection;
    function Get_Barriers: IDMCollection;
    function Get_BarrierFixtures: IDMCollection;
    function Get_Locks: IDMCollection;
    function Get_UndergroundObstacles: IDMCollection;
    function Get_ActiveSafeguards: IDMCollection;
    function Get_SurfaceSensors: IDMCollection;
    function Get_PositionSensors: IDMCollection;
    function Get_VolumeSensors: IDMCollection;
    function Get_BarrierSensors: IDMCollection;
    function Get_PerimeterSensors: IDMCollection;
    function Get_ContrabandSensors: IDMCollection;
    function Get_AccessControls: IDMCollection;
    function Get_TVCameras: IDMCollection;
    function Get_LightDevices: IDMCollection;
    function Get_CommunicationDevices: IDMCollection;
    function Get_SignalDevices: IDMCollection;
    function Get_PowerSources: IDMCollection;
    function Get_Cabels: IDMCollection;
    function Get_GuardPosts: IDMCollection;
    function Get_PatrolPaths: IDMCollection;
    function Get_Targets: IDMCollection;
    function Get_Conveyances: IDMCollection;
    function Get_LocalPointObjects: IDMCollection;
    function Get_Jumps: IDMCollection;
    function Get_StartPoints: IDMCollection;
    function Get_GuardVariants: IDMCollection;
    function Get_GuardGroups: IDMCollection;
    function Get_Weapons: IDMCollection;
    function Get_Vehicles: IDMCollection;
    function Get_Skills: IDMCollection;
    function Get_AdversaryVariants: IDMCollection;
    function Get_AdversaryGroups: IDMCollection;
    function Get_Tools: IDMCollection;
    function Get_SafeguardDatabase: IUnknown;
    function Get_Athorities: IDMCollection;
    function Get_Enviroments: IDMElement;
    function Get_AnalysisVariants: IDMCollection;
    function Get_CurrentBoundaryTactics: IDMCollection;
    function Get_ExtraTargets: IDMCollection;
    function Get_CurrentZoneTactics: IDMCollection;
    function Get_TechnicalServices: IDMCollection;
    function Get_CurrentTactic: IDMElement;
    procedure Set_CurrentTactic(const Value: IDMElement);
    function Get_Roads: IDMCollection;
    function Get_UserDefinedPaths: IDMCollection;
    function Get_Accesses: IDMCollection;
    function Get_GroundObstacles: IDMCollection;
    function Get_FenceObstacles: IDMCollection;
    function Get_DelayTimeDispersionRatio: Double;
    procedure Set_DelayTimeDispersionRatio(Value: Double);
    function Get_ResponceTimeDispersionRatio: Double;
    procedure Set_ResponceTimeDispersionRatio(Value: Double);
    function Get_BattleModel: IUnknown;
    procedure Set_BattleModel(const Value: IUnknown);
    function Get_BuildSectorLayer: IDMElement;
    procedure Set_BuildSectorLayer(const Value: IDMElement);
    function Get_DefaultReactionMode: Integer;
    procedure Set_DefaultReactionMode(Value: Integer);
    function Get_CriticalFalseAlarmPeriod: Double;
    procedure Set_CriticalFalseAlarmPeriod(Value: Double);
    function Get_FalseAlarmPeriod: Double;
    procedure Set_FalseAlarmPeriod(Value: Double);
    function Get_UserDefinedElements: IDMCollection;
    function Get_UseBattleModel: WordBool;
    procedure Set_UseBattleModel(Value: WordBool);
    function Get_BuildAllVerticalWays: WordBool;
    procedure Set_BuildAllVerticalWays(Value: WordBool);
    function Get_WarriorPathElements: IDMCollection;
    function Get_Connections: IDMCollection;
    function Get_ControlDevices: IDMCollection;
    function Get_CurrencyRate: Double;
    procedure Set_CurrencyRate(Value: Double);
    function Get_PriceCoeffD: Double;
    procedure Set_PriceCoeffD(Value: Double);
    function Get_PriceCoeffTZSR: Double;
    procedure Set_PriceCoeffTZSR(Value: Double);
    function Get_PriceCoeffPNR: Double;
    procedure Set_PriceCoeffPNR(Value: Double);
    function Get_SafeguardSynthesis: IDataModel;
    function Get_CriticalPoints: IDMCollection;
    function Get_FMRecomendations: IDMCollection;
    function Get_TotalEfficiencyCalcMode: Integer;
    procedure Set_TotalEfficiencyCalcMode(Value: Integer);
    function Get_TotalEfficiency: Double;
    function Get_TotalPrice: Double;
    function Get_FindCriticalPointsFlag: WordBool;
    procedure Set_FindCriticalPointsFlag(Value: WordBool);
    function Get_CurrentZoneFastTactics: IDMCollection;
    function Get_CurrentZoneStealthTactics: IDMCollection;
    function Get_UpdateDependingElementsBestMethodsFlag: WordBool;
    procedure Set_UpdateDependingElementsBestMethodsFlag(Value: WordBool);
    function Get_MaxBoundaryDistance: Double;
    procedure Set_MaxBoundaryDistance(Value: Double);
    function Get_MaxPathAlongBoundaryDistance: Double;
    procedure Set_MaxPathAlongBoundaryDistance(Value: Double);
    function Get_FastPathColor: Integer;
    procedure Set_FastPathColor(Value: Integer);
    function Get_StealthPathColor: Integer;
    procedure Set_StealthPathColor(Value: Integer);
    function Get_RationalPathColor: Integer;
    procedure Set_RationalPathColor(Value: Integer);
    function Get_GuardPathColor: Integer;
    procedure Set_GuardPathColor(Value: Integer);
    function Get_PathHeight: Double;
    procedure Set_PathHeight(Value: Double);
    function Get_ShoulderWidth: Double;
    procedure Set_ShoulderWidth(Value: Double);
    function Get_GraphColor: Integer;
    procedure Set_GraphColor(Value: Integer);
    function Get_UserDefinedPathLayer: IDMElement;
    procedure Set_UserDefinedPathLayer(const Value: IDMElement);
    function Get_ShowSingleLayer: WordBool;
    procedure Set_ShowSingleLayer(Value: WordBool);
    function Get_ZoneDelayTimeDispersionRatio: Double;
    procedure Set_ZoneDelayTimeDispersionRatio(Value: Double);
    function Get_DefaultOpenZoneHeight: Double;
    procedure Set_DefaultOpenZoneHeight(Value: Double);
    function Get_OvercomingBoundaries: IDMCollection;
    function Get_UseSimpleBattleModel: WordBool;
    procedure Set_UseSimpleBattleModel(Value: WordBool);
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IFacilityModel);
    procedure Disconnect; override;
    function FindSeparatingAreas(C0X: Double; C0Y: Double; C0Z: Double; C1X: Double; C1Y: Double; 
                                 C1Z: Double; const C0Ref: IDMElement; const C1Ref: IDMElement; 
                                 WhileTransparent: Integer; const SeparatingAreas: IDMCollection; 
                                 var TransparencyCoeff: Double; const ExcludeArea0E: IDMElement; 
                                 const ExcludeArea1E: IDMElement): WordBool;
    procedure CalcFalseAlarmPeriod(const FacilityStateE: IDMElement);
    procedure CalcEfficiency;
    procedure CalcPrice(ModificationStage: Integer);
    procedure MakeRecomendations;
    procedure MakePersistant;
    procedure Reset(const BaseStateE: IDMElement);
    function MakePathFrom(const NodeE: IDMElement; Reversed: WordBool; PathKind: Integer; 
                          UseStoredRecords: WordBool; const Paths: IDMCollection; 
                          const PathLayerE: IDMElement; var BoundaryPath: IDMElement): IDMElement;
    property DefaultInterface: IFacilityModel read GetDefaultInterface;
    property Zones: IDMCollection read Get_Zones;
    property Boundaries: IDMCollection read Get_Boundaries;
    property BoundaryLayers: IDMCollection read Get_BoundaryLayers;
    property FacilityStates: IDMCollection read Get_FacilityStates;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TFacilityModelProperties read GetServerProperties;
{$ENDIF}
  end;
...
// *********************************************************************//
 TFacilityModelProperties = class(TPersistent)
  private
    FServer:    TFacilityModel;
    function    GetDefaultInterface: IFacilityModel;
    constructor Create(AServer: TFacilityModel);
  protected
    function Get_Zones: IDMCollection;
    function Get_Boundaries: IDMCollection;
    function Get_BoundaryLayers: IDMCollection;
...
procedure TFacilityModel.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{5F8591B9-0FE6-11D6-9328-0050BA51A6D3}';
    IntfIID:   '{9DCB5BA3-14B5-11D6-932D-0050BA51A6D3}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
procedure TFacilityModel.Connect;
var
  punk: IUnknown;
begin
  if FIntf = nil then
  begin
    punk := GetServer;
    Fintf:= punk as IFacilityModel;
  end;
end;

procedure TFacilityModel.ConnectTo(svrIntf: IFacilityModel);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TFacilityModel.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TFacilityModel.GetDefaultInterface: IFacilityModel;
begin
  if FIntf = nil then
    Connect;
...
constructor TFacilityModel.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TFacilityModelProperties.Create(Self);
{$ENDIF}
end;

destructor TFacilityModel.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TFacilityModel.GetServerProperties: TFacilityModelProperties;
begin
  Result := FProps;
end;
{$ENDIF}

function TFacilityModel.Get_Zones: IDMCollection;
begin
    Result := DefaultInterface.Zones;
end;

function TFacilityModel.Get_Boundaries: IDMCollection;
begin
    Result := DefaultInterface.Boundaries;
end;

function TFacilityModel.Get_BoundaryLayers: IDMCollection;
begin
    Result := DefaultInterface.BoundaryLayers;
end;

function TFacilityModel.Get_FacilityStates: IDMCollection;
begin
    Result := DefaultInterface.FacilityStates;
end;

function TFacilityModel.Get_FacilitySubStates: IDMCollection;
begin
    Result := DefaultInterface.FacilitySubStates;
end;

function TFacilityModel.Get_ZoneStates: IDMCollection;
begin
    Result := DefaultInterface.ZoneStates;
end;

function TFacilityModel.Get_BoundaryLayerStates: IDMCollection;
begin
    Result := DefaultInterface.BoundaryLayerStates;
end;

function TFacilityModel.Get_SafeguardElementStates: IDMCollection;
begin
    Result := DefaultInterface.SafeguardElementStates;
end;

function TFacilityModel.Get_WarriorPaths: IDMCollection;
begin
    Result := DefaultInterface.WarriorPaths;
end;

function TFacilityModel.Get_Barriers: IDMCollection;
begin
    Result := DefaultInterface.Barriers;
end;

function TFacilityModel.Get_BarrierFixtures: IDMCollection;
begin
    Result := DefaultInterface.BarrierFixtures;
end;

function TFacilityModel.Get_Locks: IDMCollection;
begin
    Result := DefaultInterface.Locks;
end;

function TFacilityModel.Get_UndergroundObstacles: IDMCollection;
begin
    Result := DefaultInterface.UndergroundObstacles;
end;

function TFacilityModel.Get_ActiveSafeguards: IDMCollection;
begin
    Result := DefaultInterface.ActiveSafeguards;
end;

function TFacilityModel.Get_SurfaceSensors: IDMCollection;
begin
    Result := DefaultInterface.SurfaceSensors;
end;

function TFacilityModel.Get_PositionSensors: IDMCollection;
begin
    Result := DefaultInterface.PositionSensors;
end;

function TFacilityModel.Get_VolumeSensors: IDMCollection;
begin
    Result := DefaultInterface.VolumeSensors;
end;

function TFacilityModel.Get_BarrierSensors: IDMCollection;
begin
    Result := DefaultInterface.BarrierSensors;
end;

function TFacilityModel.Get_PerimeterSensors: IDMCollection;
begin
    Result := DefaultInterface.PerimeterSensors;
end;

function TFacilityModel.Get_ContrabandSensors: IDMCollection;
begin
    Result := DefaultInterface.ContrabandSensors;
end;

function TFacilityModel.Get_AccessControls: IDMCollection;
begin
    Result := DefaultInterface.AccessControls;
end;

function TFacilityModel.Get_TVCameras: IDMCollection;
begin
    Result := DefaultInterface.TVCameras;
end;

function TFacilityModel.Get_LightDevices: IDMCollection;
begin
    Result := DefaultInterface.LightDevices;
end;

function TFacilityModel.Get_CommunicationDevices: IDMCollection;
begin
    Result := DefaultInterface.CommunicationDevices;
end;

function TFacilityModel.Get_SignalDevices: IDMCollection;
begin
    Result := DefaultInterface.SignalDevices;
end;

function TFacilityModel.Get_PowerSources: IDMCollection;
begin
    Result := DefaultInterface.PowerSources;
end;

function TFacilityModel.Get_Cabels: IDMCollection;
begin
    Result := DefaultInterface.Cabels;
end;

function TFacilityModel.Get_GuardPosts: IDMCollection;
begin
    Result := DefaultInterface.GuardPosts;
end;

function TFacilityModel.Get_PatrolPaths: IDMCollection;
begin
    Result := DefaultInterface.PatrolPaths;
end;

function TFacilityModel.Get_Targets: IDMCollection;
begin
    Result := DefaultInterface.Targets;
end;

function TFacilityModel.Get_Conveyances: IDMCollection;
begin
    Result := DefaultInterface.Conveyances;
end;

function TFacilityModel.Get_LocalPointObjects: IDMCollection;
begin
    Result := DefaultInterface.LocalPointObjects;
end;

function TFacilityModel.Get_Jumps: IDMCollection;
begin
    Result := DefaultInterface.Jumps;
end;

function TFacilityModel.Get_StartPoints: IDMCollection;
begin
    Result := DefaultInterface.StartPoints;
end;

function TFacilityModel.Get_GuardVariants: IDMCollection;
begin
    Result := DefaultInterface.GuardVariants;
end;

function TFacilityModel.Get_GuardGroups: IDMCollection;
begin
    Result := DefaultInterface.GuardGroups;
end;

function TFacilityModel.Get_Weapons: IDMCollection;
begin
    Result := DefaultInterface.Weapons;
end;

function TFacilityModel.Get_Vehicles: IDMCollection;
begin
    Result := DefaultInterface.Vehicles;
end;

function TFacilityModel.Get_Skills: IDMCollection;
begin
    Result := DefaultInterface.Skills;
end;

function TFacilityModel.Get_AdversaryVariants: IDMCollection;
begin
    Result := DefaultInterface.AdversaryVariants;
end;

function TFacilityModel.Get_AdversaryGroups: IDMCollection;
begin
    Result := DefaultInterface.AdversaryGroups;
end;

function TFacilityModel.Get_Tools: IDMCollection;
begin
    Result := DefaultInterface.Tools;
end;

function TFacilityModel.Get_SafeguardDatabase: IUnknown;
begin
    Result := DefaultInterface.SafeguardDatabase;
end;

function TFacilityModel.Get_Athorities: IDMCollection;
begin
    Result := DefaultInterface.Athorities;
end;

function TFacilityModel.Get_Enviroments: IDMElement;
begin
    Result := DefaultInterface.Enviroments;
end;

function TFacilityModel.Get_AnalysisVariants: IDMCollection;
begin
    Result := DefaultInterface.AnalysisVariants;
end;

function TFacilityModel.Get_CurrentBoundaryTactics: IDMCollection;
begin
    Result := DefaultInterface.CurrentBoundaryTactics;
end;

function TFacilityModel.Get_ExtraTargets: IDMCollection;
begin
    Result := DefaultInterface.ExtraTargets;
end;

function TFacilityModel.Get_CurrentZoneTactics: IDMCollection;
begin
    Result := DefaultInterface.CurrentZoneTactics;
end;

function TFacilityModel.Get_TechnicalServices: IDMCollection;
begin
    Result := DefaultInterface.TechnicalServices;
end;

function TFacilityModel.Get_CurrentTactic: IDMElement;
begin
    Result := DefaultInterface.CurrentTactic;
end;

procedure TFacilityModel.Set_CurrentTactic(const Value: IDMElement);
begin
  Exit;
end;

function TFacilityModel.Get_Roads: IDMCollection;
begin
    Result := DefaultInterface.Roads;
end;

function TFacilityModel.Get_UserDefinedPaths: IDMCollection;
begin
    Result := DefaultInterface.UserDefinedPaths;
end;

function TFacilityModel.Get_Accesses: IDMCollection;
begin
    Result := DefaultInterface.Accesses;
end;

function TFacilityModel.Get_GroundObstacles: IDMCollection;
begin
    Result := DefaultInterface.GroundObstacles;
end;

function TFacilityModel.Get_FenceObstacles: IDMCollection;
begin
    Result := DefaultInterface.FenceObstacles;
end;

function TFacilityModel.Get_DelayTimeDispersionRatio: Double;
begin
    Result := DefaultInterface.DelayTimeDispersionRatio;
end;

procedure TFacilityModel.Set_DelayTimeDispersionRatio(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_ResponceTimeDispersionRatio: Double;
begin
    Result := DefaultInterface.ResponceTimeDispersionRatio;
end;

procedure TFacilityModel.Set_ResponceTimeDispersionRatio(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_BattleModel: IUnknown;
begin
    Result := DefaultInterface.BattleModel;
end;

procedure TFacilityModel.Set_BattleModel(const Value: IUnknown);
begin
  Exit;
end;

function TFacilityModel.Get_BuildSectorLayer: IDMElement;
begin
    Result := DefaultInterface.BuildSectorLayer;
end;

procedure TFacilityModel.Set_BuildSectorLayer(const Value: IDMElement);
begin
  Exit;
end;

function TFacilityModel.Get_DefaultReactionMode: Integer;
begin
    Result := DefaultInterface.DefaultReactionMode;
end;

procedure TFacilityModel.Set_DefaultReactionMode(Value: Integer);
begin
  Exit;
end;

function TFacilityModel.Get_CriticalFalseAlarmPeriod: Double;
begin
    Result := DefaultInterface.CriticalFalseAlarmPeriod;
end;

procedure TFacilityModel.Set_CriticalFalseAlarmPeriod(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_FalseAlarmPeriod: Double;
begin
    Result := DefaultInterface.FalseAlarmPeriod;
end;

procedure TFacilityModel.Set_FalseAlarmPeriod(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_UserDefinedElements: IDMCollection;
begin
    Result := DefaultInterface.UserDefinedElements;
end;

function TFacilityModel.Get_UseBattleModel: WordBool;
begin
    Result := DefaultInterface.UseBattleModel;
end;

procedure TFacilityModel.Set_UseBattleModel(Value: WordBool);
begin
  Exit;
end;

function TFacilityModel.Get_BuildAllVerticalWays: WordBool;
begin
    Result := DefaultInterface.BuildAllVerticalWays;
end;

procedure TFacilityModel.Set_BuildAllVerticalWays(Value: WordBool);
begin
  Exit;
end;

function TFacilityModel.Get_WarriorPathElements: IDMCollection;
begin
    Result := DefaultInterface.WarriorPathElements;
end;

function TFacilityModel.Get_Connections: IDMCollection;
begin
    Result := DefaultInterface.Connections;
end;

function TFacilityModel.Get_ControlDevices: IDMCollection;
begin
    Result := DefaultInterface.ControlDevices;
end;

function TFacilityModel.Get_CurrencyRate: Double;
begin
    Result := DefaultInterface.CurrencyRate;
end;

procedure TFacilityModel.Set_CurrencyRate(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_PriceCoeffD: Double;
begin
    Result := DefaultInterface.PriceCoeffD;
end;

procedure TFacilityModel.Set_PriceCoeffD(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_PriceCoeffTZSR: Double;
begin
    Result := DefaultInterface.PriceCoeffTZSR;
end;

procedure TFacilityModel.Set_PriceCoeffTZSR(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_PriceCoeffPNR: Double;
begin
    Result := DefaultInterface.PriceCoeffPNR;
end;

procedure TFacilityModel.Set_PriceCoeffPNR(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_SafeguardSynthesis: IDataModel;
begin
    Result := DefaultInterface.SafeguardSynthesis;
end;

function TFacilityModel.Get_CriticalPoints: IDMCollection;
begin
    Result := DefaultInterface.CriticalPoints;
end;

function TFacilityModel.Get_FMRecomendations: IDMCollection;
begin
    Result := DefaultInterface.FMRecomendations;
end;

function TFacilityModel.Get_TotalEfficiencyCalcMode: Integer;
begin
    Result := DefaultInterface.TotalEfficiencyCalcMode;
end;

procedure TFacilityModel.Set_TotalEfficiencyCalcMode(Value: Integer);
begin
  Exit;
end;

function TFacilityModel.Get_TotalEfficiency: Double;
begin
    Result := DefaultInterface.TotalEfficiency;
end;

function TFacilityModel.Get_TotalPrice: Double;
begin
    Result := DefaultInterface.TotalPrice;
end;

function TFacilityModel.Get_FindCriticalPointsFlag: WordBool;
begin
    Result := DefaultInterface.FindCriticalPointsFlag;
end;

procedure TFacilityModel.Set_FindCriticalPointsFlag(Value: WordBool);
begin
  Exit;
end;

function TFacilityModel.Get_CurrentZoneFastTactics: IDMCollection;
begin
    Result := DefaultInterface.CurrentZoneFastTactics;
end;

function TFacilityModel.Get_CurrentZoneStealthTactics: IDMCollection;
begin
    Result := DefaultInterface.CurrentZoneStealthTactics;
end;

function TFacilityModel.Get_UpdateDependingElementsBestMethodsFlag: WordBool;
begin
    Result := DefaultInterface.UpdateDependingElementsBestMethodsFlag;
end;

procedure TFacilityModel.Set_UpdateDependingElementsBestMethodsFlag(Value: WordBool);
begin
  Exit;
end;

function TFacilityModel.Get_MaxBoundaryDistance: Double;
begin
    Result := DefaultInterface.MaxBoundaryDistance;
end;

procedure TFacilityModel.Set_MaxBoundaryDistance(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_MaxPathAlongBoundaryDistance: Double;
begin
    Result := DefaultInterface.MaxPathAlongBoundaryDistance;
end;

procedure TFacilityModel.Set_MaxPathAlongBoundaryDistance(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_FastPathColor: Integer;
begin
    Result := DefaultInterface.FastPathColor;
end;

procedure TFacilityModel.Set_FastPathColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModel.Get_StealthPathColor: Integer;
begin
    Result := DefaultInterface.StealthPathColor;
end;

procedure TFacilityModel.Set_StealthPathColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModel.Get_RationalPathColor: Integer;
begin
    Result := DefaultInterface.RationalPathColor;
end;

procedure TFacilityModel.Set_RationalPathColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModel.Get_GuardPathColor: Integer;
begin
    Result := DefaultInterface.GuardPathColor;
end;

procedure TFacilityModel.Set_GuardPathColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModel.Get_PathHeight: Double;
begin
    Result := DefaultInterface.PathHeight;
end;

procedure TFacilityModel.Set_PathHeight(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_ShoulderWidth: Double;
begin
    Result := DefaultInterface.ShoulderWidth;
end;

procedure TFacilityModel.Set_ShoulderWidth(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_GraphColor: Integer;
begin
    Result := DefaultInterface.GraphColor;
end;

procedure TFacilityModel.Set_GraphColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModel.Get_UserDefinedPathLayer: IDMElement;
begin
    Result := DefaultInterface.UserDefinedPathLayer;
end;

procedure TFacilityModel.Set_UserDefinedPathLayer(const Value: IDMElement);
begin
  Exit;
end;

function TFacilityModel.Get_ShowSingleLayer: WordBool;
begin
    Result := DefaultInterface.ShowSingleLayer;
end;

procedure TFacilityModel.Set_ShowSingleLayer(Value: WordBool);
begin
  Exit;
end;

function TFacilityModel.Get_ZoneDelayTimeDispersionRatio: Double;
begin
    Result := DefaultInterface.ZoneDelayTimeDispersionRatio;
end;

procedure TFacilityModel.Set_ZoneDelayTimeDispersionRatio(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_DefaultOpenZoneHeight: Double;
begin
    Result := DefaultInterface.DefaultOpenZoneHeight;
end;

procedure TFacilityModel.Set_DefaultOpenZoneHeight(Value: Double);
begin
  Exit;
end;

function TFacilityModel.Get_OvercomingBoundaries: IDMCollection;
begin
    Result := DefaultInterface.OvercomingBoundaries;
end;

function TFacilityModel.Get_UseSimpleBattleModel: WordBool;
begin
    Result := DefaultInterface.UseSimpleBattleModel;
end;

procedure TFacilityModel.Set_UseSimpleBattleModel(Value: WordBool);
begin
  Exit;
end;

function TFacilityModel.FindSeparatingAreas(C0X: Double; C0Y: Double; C0Z: Double; C1X: Double; 
                                            C1Y: Double; C1Z: Double; const C0Ref: IDMElement; 
                                            const C1Ref: IDMElement; WhileTransparent: Integer; 
                                            const SeparatingAreas: IDMCollection; 
                                            var TransparencyCoeff: Double; 
                                            const ExcludeArea0E: IDMElement; 
                                            const ExcludeArea1E: IDMElement): WordBool;
begin
  Result := DefaultInterface.FindSeparatingAreas(C0X, C0Y, C0Z, C1X, C1Y, C1Z, C0Ref, C1Ref, 
                                                 WhileTransparent, SeparatingAreas, 
                                                 TransparencyCoeff, ExcludeArea0E, ExcludeArea1E);
end;

procedure TFacilityModel.CalcFalseAlarmPeriod(const FacilityStateE: IDMElement);
begin
  DefaultInterface.CalcFalseAlarmPeriod(FacilityStateE);
end;

procedure TFacilityModel.CalcEfficiency;
begin
  DefaultInterface.CalcEfficiency;
end;

procedure TFacilityModel.CalcPrice(ModificationStage: Integer);
begin
  DefaultInterface.CalcPrice(ModificationStage);
end;

procedure TFacilityModel.MakeRecomendations;
begin
  DefaultInterface.MakeRecomendations;
end;

procedure TFacilityModel.MakePersistant;
begin
  DefaultInterface.MakePersistant;
end;

procedure TFacilityModel.Reset(const BaseStateE: IDMElement);
begin
  DefaultInterface.Reset(BaseStateE);
end;

function TFacilityModel.MakePathFrom(const NodeE: IDMElement; Reversed: WordBool; 
                                     PathKind: Integer; UseStoredRecords: WordBool; 
                                     const Paths: IDMCollection; const PathLayerE: IDMElement; 
                                     var BoundaryPath: IDMElement): IDMElement;
begin
  Result := DefaultInterface.MakePathFrom(NodeE, Reversed, PathKind, UseStoredRecords, Paths, 
                                          PathLayerE, BoundaryPath);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TFacilityModelProperties.Create(AServer: TFacilityModel);
begin
  inherited Create;
  FServer := AServer;
end;

function TFacilityModelProperties.GetDefaultInterface: IFacilityModel;
begin
  Result := FServer.DefaultInterface;
end;

function TFacilityModelProperties.Get_Zones: IDMCollection;
begin
    Result := DefaultInterface.Zones;
end;

function TFacilityModelProperties.Get_Boundaries: IDMCollection;
begin
    Result := DefaultInterface.Boundaries;
end;

function TFacilityModelProperties.Get_BoundaryLayers: IDMCollection;
begin
    Result := DefaultInterface.BoundaryLayers;
end;

function TFacilityModelProperties.Get_FacilityStates: IDMCollection;
begin
    Result := DefaultInterface.FacilityStates;
end;

function TFacilityModelProperties.Get_FacilitySubStates: IDMCollection;
begin
    Result := DefaultInterface.FacilitySubStates;
end;

function TFacilityModelProperties.Get_ZoneStates: IDMCollection;
begin
    Result := DefaultInterface.ZoneStates;
end;

function TFacilityModelProperties.Get_BoundaryLayerStates: IDMCollection;
begin
    Result := DefaultInterface.BoundaryLayerStates;
end;

function TFacilityModelProperties.Get_SafeguardElementStates: IDMCollection;
begin
    Result := DefaultInterface.SafeguardElementStates;
end;

function TFacilityModelProperties.Get_WarriorPaths: IDMCollection;
begin
    Result := DefaultInterface.WarriorPaths;
end;

function TFacilityModelProperties.Get_Barriers: IDMCollection;
begin
    Result := DefaultInterface.Barriers;
end;

function TFacilityModelProperties.Get_BarrierFixtures: IDMCollection;
begin
    Result := DefaultInterface.BarrierFixtures;
end;

function TFacilityModelProperties.Get_Locks: IDMCollection;
begin
    Result := DefaultInterface.Locks;
end;

function TFacilityModelProperties.Get_UndergroundObstacles: IDMCollection;
begin
    Result := DefaultInterface.UndergroundObstacles;
end;

function TFacilityModelProperties.Get_ActiveSafeguards: IDMCollection;
begin
    Result := DefaultInterface.ActiveSafeguards;
end;

function TFacilityModelProperties.Get_SurfaceSensors: IDMCollection;
begin
    Result := DefaultInterface.SurfaceSensors;
end;

function TFacilityModelProperties.Get_PositionSensors: IDMCollection;
begin
    Result := DefaultInterface.PositionSensors;
end;

function TFacilityModelProperties.Get_VolumeSensors: IDMCollection;
begin
    Result := DefaultInterface.VolumeSensors;
end;

function TFacilityModelProperties.Get_BarrierSensors: IDMCollection;
begin
    Result := DefaultInterface.BarrierSensors;
end;

function TFacilityModelProperties.Get_PerimeterSensors: IDMCollection;
begin
    Result := DefaultInterface.PerimeterSensors;
end;

function TFacilityModelProperties.Get_ContrabandSensors: IDMCollection;
begin
    Result := DefaultInterface.ContrabandSensors;
end;

function TFacilityModelProperties.Get_AccessControls: IDMCollection;
begin
    Result := DefaultInterface.AccessControls;
end;

function TFacilityModelProperties.Get_TVCameras: IDMCollection;
begin
    Result := DefaultInterface.TVCameras;
end;

function TFacilityModelProperties.Get_LightDevices: IDMCollection;
begin
    Result := DefaultInterface.LightDevices;
end;

function TFacilityModelProperties.Get_CommunicationDevices: IDMCollection;
begin
    Result := DefaultInterface.CommunicationDevices;
end;

function TFacilityModelProperties.Get_SignalDevices: IDMCollection;
begin
    Result := DefaultInterface.SignalDevices;
end;

function TFacilityModelProperties.Get_PowerSources: IDMCollection;
begin
    Result := DefaultInterface.PowerSources;
end;

function TFacilityModelProperties.Get_Cabels: IDMCollection;
begin
    Result := DefaultInterface.Cabels;
end;

function TFacilityModelProperties.Get_GuardPosts: IDMCollection;
begin
    Result := DefaultInterface.GuardPosts;
end;

function TFacilityModelProperties.Get_PatrolPaths: IDMCollection;
begin
    Result := DefaultInterface.PatrolPaths;
end;

function TFacilityModelProperties.Get_Targets: IDMCollection;
begin
    Result := DefaultInterface.Targets;
end;

function TFacilityModelProperties.Get_Conveyances: IDMCollection;
begin
    Result := DefaultInterface.Conveyances;
end;

function TFacilityModelProperties.Get_LocalPointObjects: IDMCollection;
begin
    Result := DefaultInterface.LocalPointObjects;
end;

function TFacilityModelProperties.Get_Jumps: IDMCollection;
begin
    Result := DefaultInterface.Jumps;
end;

function TFacilityModelProperties.Get_StartPoints: IDMCollection;
begin
    Result := DefaultInterface.StartPoints;
end;

function TFacilityModelProperties.Get_GuardVariants: IDMCollection;
begin
    Result := DefaultInterface.GuardVariants;
end;

function TFacilityModelProperties.Get_GuardGroups: IDMCollection;
begin
    Result := DefaultInterface.GuardGroups;
end;

function TFacilityModelProperties.Get_Weapons: IDMCollection;
begin
    Result := DefaultInterface.Weapons;
end;

function TFacilityModelProperties.Get_Vehicles: IDMCollection;
begin
    Result := DefaultInterface.Vehicles;
end;

function TFacilityModelProperties.Get_Skills: IDMCollection;
begin
    Result := DefaultInterface.Skills;
end;

function TFacilityModelProperties.Get_AdversaryVariants: IDMCollection;
begin
    Result := DefaultInterface.AdversaryVariants;
end;

function TFacilityModelProperties.Get_AdversaryGroups: IDMCollection;
begin
    Result := DefaultInterface.AdversaryGroups;
end;

function TFacilityModelProperties.Get_Tools: IDMCollection;
begin
    Result := DefaultInterface.Tools;
end;

function TFacilityModelProperties.Get_SafeguardDatabase: IUnknown;
begin
    Result := DefaultInterface.SafeguardDatabase;
end;

function TFacilityModelProperties.Get_Athorities: IDMCollection;
begin
    Result := DefaultInterface.Athorities;
end;

function TFacilityModelProperties.Get_Enviroments: IDMElement;
begin
    Result := DefaultInterface.Enviroments;
end;

function TFacilityModelProperties.Get_AnalysisVariants: IDMCollection;
begin
    Result := DefaultInterface.AnalysisVariants;
end;

function TFacilityModelProperties.Get_CurrentBoundaryTactics: IDMCollection;
begin
    Result := DefaultInterface.CurrentBoundaryTactics;
end;

function TFacilityModelProperties.Get_ExtraTargets: IDMCollection;
begin
    Result := DefaultInterface.ExtraTargets;
end;

function TFacilityModelProperties.Get_CurrentZoneTactics: IDMCollection;
begin
    Result := DefaultInterface.CurrentZoneTactics;
end;

function TFacilityModelProperties.Get_TechnicalServices: IDMCollection;
begin
    Result := DefaultInterface.TechnicalServices;
end;

function TFacilityModelProperties.Get_CurrentTactic: IDMElement;
begin
    Result := DefaultInterface.CurrentTactic;
end;

procedure TFacilityModelProperties.Set_CurrentTactic(const Value: IDMElement);
begin
  Exit;
end;

function TFacilityModelProperties.Get_Roads: IDMCollection;
begin
    Result := DefaultInterface.Roads;
end;

function TFacilityModelProperties.Get_UserDefinedPaths: IDMCollection;
begin
    Result := DefaultInterface.UserDefinedPaths;
end;

function TFacilityModelProperties.Get_Accesses: IDMCollection;
begin
    Result := DefaultInterface.Accesses;
end;

function TFacilityModelProperties.Get_GroundObstacles: IDMCollection;
begin
    Result := DefaultInterface.GroundObstacles;
end;

function TFacilityModelProperties.Get_FenceObstacles: IDMCollection;
begin
    Result := DefaultInterface.FenceObstacles;
end;

function TFacilityModelProperties.Get_DelayTimeDispersionRatio: Double;
begin
    Result := DefaultInterface.DelayTimeDispersionRatio;
end;

procedure TFacilityModelProperties.Set_DelayTimeDispersionRatio(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_ResponceTimeDispersionRatio: Double;
begin
    Result := DefaultInterface.ResponceTimeDispersionRatio;
end;

procedure TFacilityModelProperties.Set_ResponceTimeDispersionRatio(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_BattleModel: IUnknown;
begin
    Result := DefaultInterface.BattleModel;
end;

procedure TFacilityModelProperties.Set_BattleModel(const Value: IUnknown);
begin
  Exit;
end;

function TFacilityModelProperties.Get_BuildSectorLayer: IDMElement;
begin
    Result := DefaultInterface.BuildSectorLayer;
end;

procedure TFacilityModelProperties.Set_BuildSectorLayer(const Value: IDMElement);
begin
  Exit;
end;

function TFacilityModelProperties.Get_DefaultReactionMode: Integer;
begin
    Result := DefaultInterface.DefaultReactionMode;
end;

procedure TFacilityModelProperties.Set_DefaultReactionMode(Value: Integer);
begin
  Exit;
end;

function TFacilityModelProperties.Get_CriticalFalseAlarmPeriod: Double;
begin
    Result := DefaultInterface.CriticalFalseAlarmPeriod;
end;

procedure TFacilityModelProperties.Set_CriticalFalseAlarmPeriod(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_FalseAlarmPeriod: Double;
begin
    Result := DefaultInterface.FalseAlarmPeriod;
end;

procedure TFacilityModelProperties.Set_FalseAlarmPeriod(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_UserDefinedElements: IDMCollection;
begin
    Result := DefaultInterface.UserDefinedElements;
end;

function TFacilityModelProperties.Get_UseBattleModel: WordBool;
begin
    Result := DefaultInterface.UseBattleModel;
end;

procedure TFacilityModelProperties.Set_UseBattleModel(Value: WordBool);
begin
  Exit;
end;

function TFacilityModelProperties.Get_BuildAllVerticalWays: WordBool;
begin
    Result := DefaultInterface.BuildAllVerticalWays;
end;

procedure TFacilityModelProperties.Set_BuildAllVerticalWays(Value: WordBool);
begin
  Exit;
end;

function TFacilityModelProperties.Get_WarriorPathElements: IDMCollection;
begin
    Result := DefaultInterface.WarriorPathElements;
end;

function TFacilityModelProperties.Get_Connections: IDMCollection;
begin
    Result := DefaultInterface.Connections;
end;

function TFacilityModelProperties.Get_ControlDevices: IDMCollection;
begin
    Result := DefaultInterface.ControlDevices;
end;

function TFacilityModelProperties.Get_CurrencyRate: Double;
begin
    Result := DefaultInterface.CurrencyRate;
end;

procedure TFacilityModelProperties.Set_CurrencyRate(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_PriceCoeffD: Double;
begin
    Result := DefaultInterface.PriceCoeffD;
end;

procedure TFacilityModelProperties.Set_PriceCoeffD(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_PriceCoeffTZSR: Double;
begin
    Result := DefaultInterface.PriceCoeffTZSR;
end;

procedure TFacilityModelProperties.Set_PriceCoeffTZSR(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_PriceCoeffPNR: Double;
begin
    Result := DefaultInterface.PriceCoeffPNR;
end;

procedure TFacilityModelProperties.Set_PriceCoeffPNR(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_SafeguardSynthesis: IDataModel;
begin
    Result := DefaultInterface.SafeguardSynthesis;
end;

function TFacilityModelProperties.Get_CriticalPoints: IDMCollection;
begin
    Result := DefaultInterface.CriticalPoints;
end;

function TFacilityModelProperties.Get_FMRecomendations: IDMCollection;
begin
    Result := DefaultInterface.FMRecomendations;
end;

function TFacilityModelProperties.Get_TotalEfficiencyCalcMode: Integer;
begin
    Result := DefaultInterface.TotalEfficiencyCalcMode;
end;

procedure TFacilityModelProperties.Set_TotalEfficiencyCalcMode(Value: Integer);
begin
  Exit;
end;

function TFacilityModelProperties.Get_TotalEfficiency: Double;
begin
    Result := DefaultInterface.TotalEfficiency;
end;

function TFacilityModelProperties.Get_TotalPrice: Double;
begin
    Result := DefaultInterface.TotalPrice;
end;

function TFacilityModelProperties.Get_FindCriticalPointsFlag: WordBool;
begin
    Result := DefaultInterface.FindCriticalPointsFlag;
end;

procedure TFacilityModelProperties.Set_FindCriticalPointsFlag(Value: WordBool);
begin
  Exit;
end;

function TFacilityModelProperties.Get_CurrentZoneFastTactics: IDMCollection;
begin
    Result := DefaultInterface.CurrentZoneFastTactics;
end;

function TFacilityModelProperties.Get_CurrentZoneStealthTactics: IDMCollection;
begin
    Result := DefaultInterface.CurrentZoneStealthTactics;
end;

function TFacilityModelProperties.Get_UpdateDependingElementsBestMethodsFlag: WordBool;
begin
    Result := DefaultInterface.UpdateDependingElementsBestMethodsFlag;
end;

procedure TFacilityModelProperties.Set_UpdateDependingElementsBestMethodsFlag(Value: WordBool);
begin
  Exit;
end;

function TFacilityModelProperties.Get_MaxBoundaryDistance: Double;
begin
    Result := DefaultInterface.MaxBoundaryDistance;
end;

procedure TFacilityModelProperties.Set_MaxBoundaryDistance(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_MaxPathAlongBoundaryDistance: Double;
begin
    Result := DefaultInterface.MaxPathAlongBoundaryDistance;
end;

procedure TFacilityModelProperties.Set_MaxPathAlongBoundaryDistance(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_FastPathColor: Integer;
begin
    Result := DefaultInterface.FastPathColor;
end;

procedure TFacilityModelProperties.Set_FastPathColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModelProperties.Get_StealthPathColor: Integer;
begin
    Result := DefaultInterface.StealthPathColor;
end;

procedure TFacilityModelProperties.Set_StealthPathColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModelProperties.Get_RationalPathColor: Integer;
begin
    Result := DefaultInterface.RationalPathColor;
end;

procedure TFacilityModelProperties.Set_RationalPathColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModelProperties.Get_GuardPathColor: Integer;
begin
    Result := DefaultInterface.GuardPathColor;
end;

procedure TFacilityModelProperties.Set_GuardPathColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModelProperties.Get_PathHeight: Double;
begin
    Result := DefaultInterface.PathHeight;
end;

procedure TFacilityModelProperties.Set_PathHeight(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_ShoulderWidth: Double;
begin
    Result := DefaultInterface.ShoulderWidth;
end;

procedure TFacilityModelProperties.Set_ShoulderWidth(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_GraphColor: Integer;
begin
    Result := DefaultInterface.GraphColor;
end;

procedure TFacilityModelProperties.Set_GraphColor(Value: Integer);
begin
  Exit;
end;

function TFacilityModelProperties.Get_UserDefinedPathLayer: IDMElement;
begin
    Result := DefaultInterface.UserDefinedPathLayer;
end;

procedure TFacilityModelProperties.Set_UserDefinedPathLayer(const Value: IDMElement);
begin
  Exit;
end;

function TFacilityModelProperties.Get_ShowSingleLayer: WordBool;
begin
    Result := DefaultInterface.ShowSingleLayer;
end;

procedure TFacilityModelProperties.Set_ShowSingleLayer(Value: WordBool);
begin
  Exit;
end;

function TFacilityModelProperties.Get_ZoneDelayTimeDispersionRatio: Double;
begin
    Result := DefaultInterface.ZoneDelayTimeDispersionRatio;
end;

procedure TFacilityModelProperties.Set_ZoneDelayTimeDispersionRatio(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_DefaultOpenZoneHeight: Double;
begin
    Result := DefaultInterface.DefaultOpenZoneHeight;
end;

procedure TFacilityModelProperties.Set_DefaultOpenZoneHeight(Value: Double);
begin
  Exit;
end;

function TFacilityModelProperties.Get_OvercomingBoundaries: IDMCollection;
begin
    Result := DefaultInterface.OvercomingBoundaries;
end;

function TFacilityModelProperties.Get_UseSimpleBattleModel: WordBool;
begin
    Result := DefaultInterface.UseSimpleBattleModel;
end;

procedure TFacilityModelProperties.Set_UseSimpleBattleModel(Value: WordBool);
begin
  Exit;
end;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TFacilityModel]);
end;
