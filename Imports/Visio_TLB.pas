...
// File generated on 17.09.02 13:02:49 from Type Library described below.

// ************************************************************************  //
// Type Lib: \\Ws-3\C\Program Files\Visio\VISLIB32.dll (1)
// LIBID: {00021A98-0000-0000-C000-000000000046}
// LCID: 0
// Helpfile: \\Ws-3\C\Program Files\Visio\HELP\Vis_SDR.CHM
// DepndLst: 
...
const
  ...
  visGuideXActive = $00000000;
  visGuideYActive = $00000000;
  ...
  visLOIPlaceXPermeable = $00000000;
  visLOIPlaceYPermeable = $00000000;
  visLOIRouteNormal = $00000000;
  visLOBPlaceNormal = $00000000;
  visLOBRouteNormal = $00000000;
  visLOBRouteRightAng = $00000000;
  visLOBRouteStraight = $00000000;
  visLOBRouteFlowNS = $00000000;
  visLOBRouteFlowWE = $00000000;
  visLOBRouteTreeNS = $00000000;
  visLOBRouteTreeWE = $00000000;
  visLOBRouteManual = $00000000;
...
// *********************************************************************//
  IVApplication = interface(IDispatch)
    ...
    procedure Set_LiveDynamics(lpi2Ret: WordBool); safecall;
    function  Get_AutoLayout: WordBool; safecall;
    procedure Set_AutoLayout(lpi2Ret: WordBool); safecall;
    ...
    procedure Set_UndoEnabled(lpi2Ret: WordBool); safecall;
    function  Get_ShowChanges: WordBool; safecall;
    procedure Set_ShowChanges(lpi2Ret: WordBool); safecall;
