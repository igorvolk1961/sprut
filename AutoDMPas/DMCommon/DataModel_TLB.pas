...
// File generated on 18.04.2008 15:41:07 from Type Library described below.
...
const
  ...
  IID_IDataModel2: TGUID = '{DF3E376A-12E9-4484-BA76-935C862B1A16}';
...
// *********************************************************************//
  ...
  IDataModel2 = interface;
  IDataModel2Disp = dispinterface;
...
// *********************************************************************//
  IDataModelDisp = dispinterface
    ...
    property State: Integer dispid 46;
  end;
...
// *********************************************************************//
  IDMCollection = interface(IUnknown)
    ...
    procedure Set_Parent(const Value: IDMElement); safecall;
    function Get_DataModel: IDataModel; safecall;
    function Get_HasFields: WordBool; safecall;
    ...
    property Parent: IDMElement read Get_Parent write Set_Parent;
    property DataModel: IDataModel read Get_DataModel;
    property HasFields: WordBool read Get_HasFields;
  end;
...
// *********************************************************************//
  IDMCollectionDisp = dispinterface
    ...
    property HasFields: WordBool readonly dispid 8;
  end;
...
// *********************************************************************//
  IDMHash = interface(IDispatch)
    ...
    procedure MakeHashTables; safecall;
    procedure DeleteHashTables; safecall;
  end;
...
// *********************************************************************//
  IDMHashDisp = dispinterface
    ...
    procedure MakeHashTables; dispid 3;
    procedure DeleteHashTables; dispid 4;
  end;
...
// *********************************************************************//
// Interface: IDataModel2
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {DF3E376A-12E9-4484-BA76-935C862B1A16}
// *********************************************************************//
  IDataModel2 = interface(IDispatch)
    ['{DF3E376A-12E9-4484-BA76-935C862B1A16}']
    procedure Set_DataModel(const Param1: IDataModel); safecall;
    property DataModel: IDataModel write Set_DataModel;
  end;

// *********************************************************************//
// DispIntf:  IDataModel2Disp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {DF3E376A-12E9-4484-BA76-935C862B1A16}
// *********************************************************************//
  IDataModel2Disp = dispinterface
    ['{DF3E376A-12E9-4484-BA76-935C862B1A16}']
    property DataModel: IDataModel writeonly dispid 1610743808;
  end;
