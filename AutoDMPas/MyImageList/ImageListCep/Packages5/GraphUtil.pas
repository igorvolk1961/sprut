...
unit GraphUtil;
{*******************************************************}
{ Ётот модуль вз€т из Borland Delphi Stunio 2006        }
{ и адаптирован дл€ использовани€ в Delphi 5            }
{*******************************************************}
interface
...
var
  ...
  p2: TTriVertex absolute Vertexes;
begin
  ...
  GradientFill(ACanvas.Handle, P2, 2, @GradientRect, 1,
