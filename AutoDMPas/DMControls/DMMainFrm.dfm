  ...
  object MainMenu1: TMainMenu
    ...
    object miModel: TMenuItem
      ...
      object N25: TMenuItem
        ...
        object miCreateCircle: TMenuItem
          Caption = #1055#1086#1089#1090#1088#1086#1077#1085#1080#1077' '#1086#1082#1088#1091#1078#1085#1086#1089#1090#1077#1081
          GroupIndex = 102
          OnClick = miActionClick
        end
    ...
    object Demo1: TMenuItem
      ...
      object miWriteMacrosLabel: TMenuItem
        ...
        ShortCut = 32891
        OnClick = miWriteMacrosLabelClick
      end
    end
  end
