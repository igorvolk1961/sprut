...
// File generated on 24.01.2008 13:31:34 from Type Library described below.

// ************************************************************************  //
// Type Lib: D:\users\Volkov\AutoDM\AutoDMPas\DMControls\DMEditor.tlb (1)
...
// *********************************************************************//
  IDMEditorX = interface(IDispatch)
    ...
    property IniFileName: WideString read Get_IniFileName write Set_IniFileName;
...
// *********************************************************************//
  IDMEditorXDisp = dispinterface
    ...
    property LibraryPath: WideString dispid 32;
    property IniFileName: WideString dispid 31;
    property ApplicationVersion: WideString dispid 23;
  end;
...
// *********************************************************************//
  IDMForm = interface(IDispatch)
    ...
    procedure GetToolButtonProperties(Index: Integer; var aToolBarTag: Integer; 
                                      ...
                                      var aStyle: Integer; var aMode: Integer; var aGroup: Integer; 
                                      var aHint: WideString); safecall;
    ...
    procedure UpdateCurrentElement; safecall;
    procedure OpenDocument0; safecall;
    procedure OpenDocument1; safecall;
    procedure GetFocus; safecall;
    property DataModelServer: IUnknown read Get_DataModelServer write Set_DataModelServer;
...
// *********************************************************************//
  IDMFormDisp = dispinterface
    ...
    procedure GetToolButtonProperties(Index: Integer; var aToolBarTag: Integer; 
                                      var aButtonImageIndex: Integer; var aButtonTag: Integer; 
                                      var aStyle: Integer; var aMode: Integer; var aGroup: Integer; 
                                      var aHint: WideString); dispid 12;
    ...
    procedure UpdateCurrentElement; dispid 30;
    procedure OpenDocument0; dispid 31;
    procedure OpenDocument1; dispid 32;
    procedure GetFocus; dispid 34;
  end;
...
// *********************************************************************//
  ...
  published
    ...
    property LibraryPath: WideString index 32 read GetWideStringProp write SetWideStringProp stored False;
    property IniFileName: WideString index 31 read GetWideStringProp write SetWideStringProp stored False;
    property ApplicationVersion: WideString index 23 read GetWideStringProp write SetWideStringProp stored False;
