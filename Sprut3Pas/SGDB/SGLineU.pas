...
class function TSGLine.GetClassID: integer;
begin
  Result:=_SGLine
end;

procedure TSGLine.GetFieldValueSource(Code: Integer; var aCollection: IDMCollection);
var
...
class function TSGLines.GetElementClass: TDMElementClass;
begin
  Result:=TSGLine
end;

class function TSGLines.GetElementGUID: TGUID;
begin
  Result:=IID_ILine
end;
